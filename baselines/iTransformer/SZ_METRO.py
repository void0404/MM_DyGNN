...
from basicts.metrics import masked_mae, masked_mse, masked_mape, masked_wape
...
DATA_NAME = 'SZ_METRO'  # Dataset name
...
CFG = EasyDict()
# General settings
CFG.DESCRIPTION = 'Metro_itransformer' # Description of the experiment
...
CFG.EVAL.HORIZONS = [3, 6, 12] # Forecasting horizons to evaluate
